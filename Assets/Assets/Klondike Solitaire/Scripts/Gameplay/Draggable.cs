...
public class Draggable : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler {
	...
	virtual public void OnBeginDrag(PointerEventData eventData) {
		if (CanDrag())
		{
            ...
            //Debug.Log("the name of gameobject "+transform.gameObject.name);
            //will have to chanfge here
            //if (transform.GetComponentInParent<Tableau>() != null)
            //{
            //    transform.GetComponentInParent<Tableau>().childCards.Remove(transform.GetComponent<Card>());
            //}
	...
	private void SetNewParent() {
		//parent is set here
		//can be called from hintmanager as well
		DropZone dropZone = parentToReturnTo.GetComponent<DropZone>();
		if (dropZone)
		{
			//will have to detach from previous parent also
            //Debug.Log("assign new children");
